  ...
  return (
    <Card>
      <div className="flex gap-3">
        <div className="flex-shrink-0 w-16 h-24 rounded-sm bg-amber-100 flex items-center justify-center">
          <span className="font-heading text-2xl text-amber-700">
            {show.title.charAt(0)}
          </span>
        </div>
        <div className="min-w-0 flex-1">
          ...
          <div className="flex flex-wrap gap-1.5 mt-2">
            ...
            {show.duration_minutes && (
              <Badge variant="gray">{show.duration_minutes} min</Badge>
            )}
          </div>
          {show.ticket_url && (
            <a
